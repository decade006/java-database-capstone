...
CREATE PROCEDURE IF NOT EXISTS GetDailyAppointmentReportByDoctor(
    IN report_date DATE
)
BEGIN
...
CREATE PROCEDURE IF NOT EXISTS GetDoctorWithMostPatientsByMonth(
    IN input_month INT,
    IN input_year INT
)
BEGIN
...
CREATE PROCEDURE IF NOT EXISTS GetDoctorWithMostPatientsByYear(
    IN input_year INT
)
BEGIN
    SELECT doctor_id,
